...
2. Authentication is handled automatically via API key. If a tool returns an `api_key_error`, inform the user of a system configuration issue and halt the workflow.
