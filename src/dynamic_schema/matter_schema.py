...
MATTER_SCHEMA = [
    ...
    {"key": "access_type", "label": "Access Level", "required": False, "choices": ["restricted", "open", "private"], "aliases": ["access", "visibility"]},
    {"key": "lawyer_assignments", "label": "Assigned Lawyers", "required": False, "type": "list", "lookup_tool": "lookup_user", "aliases": ["lawyers", "attorneys"]},
